...
public class ShowApprovedUserOffersCommand implements ActionCommand {
    ...
    public String execute(HttpServletRequest request) throws CommandException {
        try {
            logger.info("ShowApprovedUserOffersCommand executed");
            String page = Path.APPROVED_USER_OFFERS_PATH;
            request.setAttribute(AttributeName.OFFER_MAP, UserOfferLogic.INSTANCE.findApprovedUserOffers(Integer.parseInt(request.getSession().getAttribute(ParamName.ID_USER_PARAM).toString())));
