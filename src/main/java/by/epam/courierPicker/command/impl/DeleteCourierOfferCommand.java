...
public class DeleteCourierOfferCommand implements ActionCommand {
    ...
    public String execute(HttpServletRequest request) throws CommandException {
        try {
            logger.info("DeleteCourierOfferCommand executed");
            String page = Path.COURIER_PAGE_PATH;
            CourierOfferLogic.INSTANCE.deleteCourierOffer(Integer.parseInt(request.getParameter(ParamName.ID_OFFER_PARAM)));
